...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:jC8tT/S0OGx2cswpeUTn4gOIea8P08lD3VFQT0cOZ50=",
    ...
    go_repository(
        ...
        sum = "h1:lkjdUzSyJ5P1+eal9fxXX9Xg2BTfswsonKUse48C0uE=",
        version = "v0.0.0-20190619014844-b5b0513f8c1b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7TYNF4UdlohbFwpNH04CoPMp1cHUZgO1Ebq5r2hIjfo=",
        version = "v0.0.0-20190916202348-b4ddaad3f8a3",
    )
    go_repository(
